      ...
      <div className="mx-auto box-content px-4 text-start text-blue-700 lg:w-[1260px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          <div className="my-8 border border-blue-500 p-8">
            ...
            <div className="mt-5">
              <p>
                Dr. John Smith has over 8 years of experience working with
                individuals suffering from Anxiety, Couples' issues, and
                Children's psychological development. He is known for his
                compassionate approach and expertise in cognitive behavioral
                therapy.
              </p>
            </div>
          </div>
